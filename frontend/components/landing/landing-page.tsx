...
const clinicPhoneDisplay = "+55 (11) 4002-1000";
const clinicPhoneHref = "tel:+551140021000";
const clinicEmail = "contato@consultorio.com";
const clinicEmailHref = "mailto:contato@consultorio.com";
const clinicLogoSrc = "/logo-suzana.jpeg";
const instagramUrl = "https://instagram.com";
const whatsappText = encodeURIComponent(
  "Olá! Gostaria de falar sobre uma consulta."
);
const whatsappUrl = `https://wa.me/551140021000?text=${whatsappText}`;
        ...
        <div className="motion-fade-up motion-delay-1 flex flex-1 flex-col justify-center py-10 sm:py-12 lg:py-14">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="interactive-soft inline-flex w-full items-center justify-center gap-2 bg-[#8abdeb] px-6 py-3 text-sm font-medium text-slate-900 hover:bg-[#7fb6e5] sm:w-auto"
            >
      ...
      <div className="mx-auto w-full max-w-7xl px-5 sm:px-8 md:px-10 lg:px-8">
        ...
        <div className="grid gap-10 pt-10 lg:grid-cols-[1.05fr_0.7fr_1fr]">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-7 text-muted">
              CRM: número a informar. Médica formada pela UFTM, especialista em
    ...
    <div className="absolute inset-0">
      ...
      >
        ...
        <g clipPath="url(#hero-circle)">
          ...
          />
          <path
            d="M292 445h46l18 38-42 46-40-46 18-38Z"
            fill="#ffffff"
          />
          <rect x="220" y="517" width="238" height="24" rx="12" fill="#d8e8f6" />
          <rect x="280" y="508" width="118" height="9" rx="4.5" fill="#9fc7ea" />
        </g>
        <rect
          x="474"
          y="279"
